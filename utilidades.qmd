...
Esta sección cubre herramientas que mejoran la experiencia general en terminal, desde corrección automática hasta personalización del prompt.

## tldr - Ejemplos prácticos de comandos {#sec-tldr}

tldr proporciona páginas de manual simplificadas con ejemplos prácticos.
...
# Configuración personalizada en ~/.tldrrc
{
    "theme": "base16",
    "platform": "macos"
}
...
- Combina `tldr` con `man` para documentación completa
